...
module.exports = (__webpack_require__(9))(128);

/***/ }),
/* 9 */
/***/ (function(module, exports) {

module.exports = lib_min;
...
var _lkWxjssdk = __webpack_require__(11);
...
var currentUrl = window.location.origin + window.location.pathname + window.location.search; // import * as React from "react";
...
(0, _lkWxjssdk.initJssdk)("/signature", {
    // 是否调试模式，默认关闭
    debug: true,
    // 获得签名请求所需数据
    data: {
    ...
    var imgUrl = "https://imgsrc.baidu.com/baike/pic/item/509b9fcb7bf335ab52664fdb.jpg";
    (0, _lkWxjssdk.wxShareAppMessage)({
        title: "自定义标题", // 分享标题
        desc: "自定义描述", // 分享描述
        imgUrl: imgUrl, // 分享图标
        link: currentUrl
    });
    (0, _lkWxjssdk.wxShareTimeline)({
        title: "自定义标题", // 分享标题
        imgUrl: imgUrl, // 分享图标
        link: currentUrl
    });
 ...
 *   });
 */
var init_1 = __webpack_require__(12);
exports.initJssdk = init_1.default;
var wxShareAppMessage_1 = __webpack_require__(34);
exports.wxShareAppMessage = wxShareAppMessage_1.default;
var wxShareTimeline_1 = __webpack_require__(35);
...
Object.defineProperty(exports, "__esModule", { value: true });
var getWxSignService_1 = __webpack_require__(13);
